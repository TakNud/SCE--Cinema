...
namespace SCECinema.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void addRoleRegister(AppUser user)
        {
            UserManager.AddToRole(user.Id, "Register");
        }
        //
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public ActionResult Edit([Bind(Include = "Email,FirstName,LastName,Birthday,PhoneNumber")] AppUser user, String PhoneNumber)
        {
            String id = User.Identity.GetUserId();
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                //Content("Your password changed Succssfuly!!!!");
                return RedirectToAction("Index", "Home");
            }
            AddErrors(result);
            return View(model);
